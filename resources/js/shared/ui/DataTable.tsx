...
/* TODO:
- Редактирование/удаление задачи (страница задачи)
- Управление тэгами задач
- Редактирование/удаление проекта (страница проекта)
- Редактирование/удаление вакансии (страница вакансии)
- Редактирование пользователя (страница пользователя)
- Управление заявками
- Сделать периоды командообразования
- Дополнить поиск всеми командами
*/
